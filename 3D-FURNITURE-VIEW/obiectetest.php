...
require_once('php/BazaDatelor.php');
require_once('./php/componenta.php');

//crearea instantei clasei BazaDatelor
$database = new BazaDatelor("Produsbaza3","Produstbc");
...
<body>
  ...
  <?php
   ...
   element($row['product_name'],$row['product_price'],$row['product_image1'],$row['product_image2'],$row['product_image3'],$row['product_change'],$row['product_class'], $row['product_site'], $row['id']);
    }
